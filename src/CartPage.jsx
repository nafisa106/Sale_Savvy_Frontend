...
const CartPage = () => {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      try {
        const response = await fetch("https://sale-savvy.onrender.com/api/cart/items", {
  ...
  const handleRemoveItem = async (productId) => {
    try {
      const response = await fetch("https://sale-savvy.onrender.com/api/cart/delete", {
        method: "DELETE",
  ...
  const handleQuantityChange = async (productId, newQuantity) => {
    try {
      ...
      const response = await fetch("https://sale-savvy.onrender.com/api/cart/update", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleCheckout = async () => {
    try {
      ...
      const response = await fetch("https://sale-savvy.onrender.com/api/payment/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      ...
      const options = {
        key: "rzp_test_T4dvnbNraR364Q", // Replace with your Razorpay Key ID
        amount: parseFloat(subtotal) * 100, // Razorpay expects amount in paise
        currency: "INR",
        name: "SalesSavvy",
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await fetch("https://sale-savvy.onrender.com/api/payment/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              credentials: "include",
              body: JSON.stringify({
            ...
            if (verifyResponse.ok) {
              ...
              setCartItems([]);// Redirect to Customer Home Page
  ...
  return (
    ...
    🎉 Congratulations! You saved ₹500 today.
            </div>
